...
# Usage: g pattern
function g() { find . -type f ! -iname "*.pyc" ! -iname "*.js" ! -iname "*.css" ! -iname "*jquery*" ! -iname "*min*" ! -iname "*less*" ! -iname "*map*" ! -iname "*.json" ! -name "*.html" ! -iname "tags" ! -iname ".ropeproject" ! -path "*.git*" ! -path "*.kitchen*" ! -path "*.bundle*" ! -path git -print0 | xargs -0 grep --colour=auto "${1}" ; }
