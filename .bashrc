...
alias agi='sudo apt install ' # shortcut for installing apps
alias agu='sudo apt update ' # shortcut for updating the repos
alias agr='sudo apt remove --purge ' # shortcut for removing a package
alias agc='sudo apt clean ' # to finish cleaning the env after deinstallation
...
alias unzipall='\ls -t *.zip | parallel unzip "{}"' # unzip all zip files in currect directory
alias unrarall='\ls -t *.rar | parallel unrar x "{}" .'  # unrar all rar files in currect directory with full paths
